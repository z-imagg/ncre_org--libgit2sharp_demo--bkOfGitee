...
class Program
{
  ...
  static void Main(string[] args){
    ...
    try{
      ...
      using (Repository repoPtr = new Repository(localRepoDir))
      {
        ...
        LibGit2Sharp.Tree tree0= GetFileListOfCommit(repoPtr, commit0.Sha);
        LibGit2Sharp.Tree tree1= GetFileListOfCommit(repoPtr, commit1.Sha);
  ...
  */
  static LibGit2Sharp.Tree GetFileListOfCommit(Repository repoPtr ,string gitCommitHash)
  {
    Commit commit=repoPtr.Lookup<Commit>(gitCommitHash);
    return commit.Tree;
  }
